  ...
  var t = "querySelector" in document && "addEventListener" in e && "requestAnimationFrame" in e && "closest" in e.Element.prototype,
    ...
    var h,
      ...
      var f = o(h || n, r || {}),
          ...
          m = d || !t.tagName ? null : t;if (d || m) {
        var g = e.pageYOffset;f.header && !p && (p = document.querySelector(f.header)), v || (v = s(p));var b,
            y,
            I,
            O = d ? t : c(m, v, parseInt("function" == typeof f.offset ? f.offset() : f.offset, 10)),
            A = O - g,
            E = u(),
            C = 0,
            w = function w(n, o) {
          var r = e.pageYOffset;if (n == o || r == o || (g < o && e.innerHeight + r) >= E) return S.cancelScroll(), l(t, o, d), f.after(t, a), b = null, !0;
        },
            Q = function Q(t) {
      ...
      if (!f() && 0 === t.button && !t.metaKey && !t.ctrlKey && (g = t.target.closest(a)) && "a" === g.tagName.toLowerCase() && !t.target.closest(h.ignore) && g.hostname === e.location.hostname && g.pathname === e.location.pathname && /#/.test(g.href)) {
        var n;try {
          ...
          t.preventDefault(), m = document.body;var o = m.id ? m.id : "smooth-scroll-top";return m.setAttribute("data-scroll-id", o), m.id = "", void (e.location.hash.substring(1) === o ? I() : e.location.hash = o);
...
$(document).ready(function () {
	...
	var scrollFireOptions = [{ selector: "#collapsible-1", offset: 250, callback: function callback() {
			$(".collapsible").collapsible("open", 0);
			$(".carousel.carousel-slider").carousel({ fullWidth: true });
			startCarousel();
		} }, { selector: "#collapsible-2", offset: 250, callback: function callback() {
			$(".collapsible").collapsible("open", 1);
			popOutFAB();
		} }, { selector: "#collapsible-3", offset: 250, callback: function callback() {
			$(".collapsible").collapsible("open", 2);
		} }, { selector: "#collapsible-4", offset: 250, callback: function callback() {
